...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary" style="background:#0d6efd!important;color:white!important;">
...
<div class="container">
        ...
        <style>
            /* https://www.bootdey.com/snippets/view/career-list#css */
            body{
    background:#f5f5f5;
    margin-top:0px;}
